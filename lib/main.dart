  ...
  Widget imageCarousel = new Container(
    ...
    return Scaffold(
      appBar: new AppBar(
        ...
        title: Center(child: Text("Merhaba"),),
        actions: <Widget>[
      ...
      drawer: new Drawer(
        child: new ListView(
          children: <Widget>[
            new UserAccountsDrawerHeader(accountName: Text("Ogün Can KAYA"), accountEmail: Text("ogun@gmail.com"),
      ...
      body: new ListView(
        children: <Widget>[
          ...
          // image dosyaları burada oluşuyor
          imageCarousel,

          // widgetlar arası boşluk burada oluşuyor ve Categori yazdırılıyor.
          new Padding(padding: const EdgeInsets.all(8.0),
          child: new Text("Categories")),


          //Horizontal list view burada başlıyor
